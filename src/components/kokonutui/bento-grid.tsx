...
const bentoItems: BentoItem[] = [
    ...
    },
    {
        ...
        description:
            "We solve one problem exceptionally well, then expand to the next. Quality over quantity. Every product is a masterpiece.",
        href: "#",
        feature: "typing",
        typingText:
    ...
    },
    {
        ...
        description:
            "Built on modern technology to ensure scalability, security, and performance for businesses of all sizes",
        icons: true,
        href: "#",
        feature: "icons",
        size: "md",
    ...
    },
    {
        ...
        timeline: [
            ...
            {
                year: "2026+",
                event: "Complete Business Software Suite",
            },
        ],
        size: "sm",
        className: "col-span-1 row-span-1",
        ...
        <div className="space-y-4 mt-4">
            <div className="space-y-3">
                <div className="flex items-center gap-3 p-3 rounded-lg bg-blue-50 dark:bg-blue-950/30 border border-blue-200/50 dark:border-blue-800/30">
                    ...
                    <span className="text-sm font-medium text-neutral-700 dark:text-neutral-300">Cloud Infrastructure</span>
                </div>
                <div className="flex items-center gap-3 p-3 rounded-lg bg-purple-50 dark:bg-purple-950/30 border border-purple-200/50 dark:border-purple-800/30">
                    <div className="w-3 h-3 rounded-full bg-purple-500"></div>
                    <span className="text-sm font-medium text-neutral-700 dark:text-neutral-300">Secure Database</span>
                </div>
                <div className="flex items-center gap-3 p-3 rounded-lg bg-green-50 dark:bg-green-950/30 border border-green-200/50 dark:border-green-800/30">
                    <div className="w-3 h-3 rounded-full bg-green-500"></div>
                    <span className="text-sm font-medium text-neutral-700 dark:text-neutral-300">Enterprise Security</span>
                </div>
                <div className="flex items-center gap-3 p-3 rounded-lg bg-indigo-50 dark:bg-indigo-950/30 border border-indigo-200/50 dark:border-indigo-800/30">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        ...
                        <motion.div
                            variants={fadeInUp}
                            className="md:col-span-1 rounded-xl overflow-hidden bg-gradient-to-br from-blue-50/80 to-purple-50/80 dark:from-blue-950/40 dark:to-purple-950/40 border border-blue-200/50 dark:border-blue-800/30 hover:border-blue-400/50 dark:hover:border-blue-700/50 hover:shadow-lg hover:shadow-blue-200/20 dark:hover:shadow-blue-900/20 transition-all duration-300"
                        >
                            <div className="p-6">
                                ...
                                <p className="text-sm text-neutral-700 dark:text-neutral-300 tracking-tight mb-6">
                                    Be part of a movement to build exceptional business software. Experience products designed with passion and built with precision.
                                </p>
                                <div className="space-y-2">
                                    <a 
                                        href="#contact" 
                                        className="w-full inline-flex items-center justify-center gap-2 px-4 py-3 bg-gradient-to-r from-blue-500 to-purple-500 text-white font-bold rounded-lg hover:from-blue-600 hover:to-purple-600 transition-all duration-300 hover:scale-105 group"
                                    >
                                    ...
                                    <a 
                                        href="#features" 
                                        className="w-full inline-flex items-center justify-center gap-2 px-4 py-3 bg-white dark:bg-neutral-900 text-blue-600 dark:text-blue-400 font-bold rounded-lg border-2 border-blue-200/50 dark:border-blue-800/50 hover:border-blue-400 dark:hover:border-blue-600 transition-all duration-300"
                                    >
                                        Learn More
                                    </a>
                                </div>
                                <p className="text-xs text-neutral-500 dark:text-neutral-400 text-center mt-4">
                                    ✨ Exceptional software, exceptional support
                                </p>
                            </div>
                        </motion.div>
                    </div>
