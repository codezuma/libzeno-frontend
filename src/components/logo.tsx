...
export const Logo = ({ className, uniColor }: { className?: string; uniColor?: boolean }) => {
    return (
        <div className={cn('flex items-center gap-2', className)}>
            ...
            <span>
                <span className="font-bold">Libzeno</span>
            </span>
        </div>
    )
}
...
export const LogoIcon = ({ className, uniColor }: { className?: string; uniColor?: boolean }) => {
    return (
        <svg
            ...
            <path
                d="M8.5 3C6.567 3 5 4.567 5 6.5V33.5C5 35.433 6.567 37 8.5 37L25 37C25 37 28.5 37 31.5 34L31.5 6C31.5 4.067 29.933 2.5 28 2.5L10.5 2.5C9.672 2.5 9 3.172 9 4C9 4.828 9.672 5.5 10.5 5.5L28 5.5C28.276 5.5 28.5 5.724 28.5 6L28.5 32.5C27.5 33.5 26 34 25 34L8.5 34C8.224 34 8 33.776 8 33.5L8 6.5C8 6.224 8.224 6 8.5 6L25 6"
                stroke={uniColor ? 'currentColor' : '#5B4FBD'}
                strokeWidth="2"
                strokeLinecap="round"
            />
            <line x1="14" y1="12" x2="22" y2="12" stroke="#4EBAB0" strokeWidth="2.5" strokeLinecap="round" />
            <line x1="14" y1="18" x2="22" y2="18" stroke="#4EBAB0" strokeWidth="2.5" strokeLinecap="round" />
            <line x1="14" y1="24" x2="22" y2="24" stroke="#4EBAB0" strokeWidth="2.5" strokeLinecap="round" />
            <defs>
                <linearGradient
                    id="logo-gradient"
                    x1="10"
